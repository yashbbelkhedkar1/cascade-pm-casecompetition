      ...
      <div className="p-4 space-y-6 pb-20">
        ...
        <div className="bg-gradient-to-r from-red-600 to-pink-600 rounded-xl p-6 text-white">
          ...
          <p className="text-red-100 text-sm mt-1">
            {fixedExpenses.filter(item => item.isActive).length} active expenses
          </p>
        </div>
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-semibold text-gray-900">Your Fixed Expenses</h3>
          {fixedExpenses.map((expense) => (
            <div key={expense.id} className="bg-white rounded-xl p-4 shadow-sm border">
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm border">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="text-center">
              <p className="text-2xl font-bold text-red-600">₹{totalMonthlyExpenses.toLocaleString()}</p>
              <p className="text-sm text-gray-600">Total Expenses</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-bold text-blue-600">{fixedExpenses.filter(item => item.isActive).length}</p>
