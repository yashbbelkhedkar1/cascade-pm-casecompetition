        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl p-6 w-full max-w-md mx-4">
            <div className="flex items-center justify-between mb-6">
              ...
              <button onClick={closeModals} className="w-8 h-8 bg-red-100 rounded-full flex items-center justify-center">
            ...
            <div className="mb-6">
              <h4 className="font-semibold text-gray-900 mb-4">{selectedLoan.type}</h4>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-xs text-gray-500 mb-1">Principal Amount</p>
                  <p className="font-semibold text-gray-900">₹{(selectedLoan.principalAmount / 100000).toFixed(1)}L</p>
                </div>
                <div>
                  <p className="text-xs text-gray-500 mb-1">Remaining</p>
                  <p className="font-semibold text-red-600">₹{(selectedLoan.remainingAmount / 100000).toFixed(1)}L</p>
                </div>
              </div>
            </div>
