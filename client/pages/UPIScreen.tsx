          ...
          {activeTab === "manual" ? (
            ...
            <div className="space-y-3">
              {[
                ...
                >
                  <div
                    className={`w-10 h-10 ${contact.color} rounded-full flex items-center justify-center text-white font-medium mr-3`}
                  >
                    {contact.name
                      .split(" ")
                      .map((n) => n[0])
      ...
      <div className="bg-white rounded-2xl w-full max-w-md max-h-[80vh] overflow-hidden">
        ...
        <div className="overflow-y-auto max-h-96">
          {contacts.map((contact, idx) => (
            ...
            >
              <div
                className={`w-12 h-12 ${contact.color} rounded-full flex items-center justify-center text-white font-medium mr-4`}
              >
                {contact.name
                  .split(" ")
                  .map((n) => n[0])
