    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-4 space-y-6 pb-20">
        ...
        <div className="space-y-4">
          <h3 className="text-lg font-semibold text-gray-900">Your Fixed Income Sources</h3>
          {fixedIncomes.map((income) => (
            <div key={income.id} className="bg-white rounded-xl p-4 shadow-sm border">
              ...
              <div className="flex items-center justify-between text-sm">
                <span className="text-gray-600">Next payment: {income.nextDate}</span>
        ...
        <div className="bg-white rounded-xl p-4 shadow-sm border">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="text-center">
              <p className="text-2xl font-bold text-blue-600">{fixedIncomes.filter(item => item.isActive).length}</p>
