  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      type: "ai",
      content:
        "Hi! I'm your AI financial assistant. I can help you track expenses, set goals, find loans, and give budgeting tips. What would you like to know?",
      timestamp: new Date(),
    },
  ]);
  ...
  const generateAIResponse = (userInput: string): Message => {
    ...
    if (input.includes("goal") || input.includes("save")) {
      return {
        ...
        type: "ai",
        content:
          "I can help you set up savings goals! Based on your spending patterns, I recommend starting with a monthly savings target of ₹5,000. Would you like me to create a goal for you?",
        timestamp: new Date(),
      };
    }
    ...
    if (input.includes("budget")) {
      return {
        ...
        type: "ai",
        content:
          "For effective budgeting, follow the 50/30/20 rule: 50% for needs, 30% for wants, and 20% for savings. Based on your income, here's a suggested budget breakdown.",
        data: {
    ...
    if (input.includes("loan") || input.includes("credit")) {
      return {
        ...
        type: "ai",
        content:
          "I can help you find the best loan options! Based on your financial profile, you're eligible for personal loans up to ₹5,00,000 at competitive rates. Would you like me to show you available options?",
        timestamp: new Date(),
      };
    }
