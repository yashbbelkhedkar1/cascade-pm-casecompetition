          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  handleInputChange("tenureMonths", e.target.value)
                }
            ...
            <div className="bg-blue-50 rounded-lg p-4">
              <label className="flex items-center">
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("allowStatusChange", e.target.checked)
                  }
                  className="sr-only"
                />
                <div
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Enable quick status updates for this loan
                  </p>
                </div>
              </label>
            ...
            <div className="bg-yellow-50 rounded-lg p-4">
              <label className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleInputChange("setReminder", e.target.checked)
                  }
