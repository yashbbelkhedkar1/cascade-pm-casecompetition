    ...
    <div className="min-h-screen bg-gray-50 max-w-md mx-auto relative">
      ...
      <div className="px-4 pb-20 relative">
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <Link to="/payment-reminders" className="bg-white rounded-xl p-4 shadow-sm border hover:shadow-md transition-shadow">
          ...
          <Link to="/wallet-ai" className="bg-white rounded-xl p-4 shadow-sm border hover:shadow-md transition-shadow">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-medium text-gray-900">WalletAI</span>
            </div>
            <p className="text-xs text-gray-600">AI Assistant</p>
          </Link>
          <Link to="/loan-management" className="bg-white rounded-xl p-4 shadow-sm border hover:shadow-md transition-shadow">
            <div className="flex items-center gap-2 mb-2">
          ...
          <Link to="/split-expenses" className="bg-white rounded-xl p-4 shadow-sm border hover:shadow-md transition-shadow">
            <div className="flex items-center gap-2 mb-2">
