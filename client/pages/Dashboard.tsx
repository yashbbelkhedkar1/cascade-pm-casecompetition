    ...
    <div className="min-h-screen bg-gray-50 max-w-md mx-auto relative">
      ...
      <div className="px-4 pb-20 relative">
        ...
        <div className="flex gap-3 mb-6">
          <Link to="/payment-reminders" className="flex-1 bg-white rounded-xl p-4 shadow-sm border hover:shadow-md transition-shadow">
            ...
            <p className="text-xs text-gray-600">5 reminders active</p>
          </Link>
          <Link to="/wallet-ai" className="flex-1 bg-white rounded-xl p-4 shadow-sm border hover:shadow-md transition-shadow">
            <div className="flex items-center gap-2 mb-2">
