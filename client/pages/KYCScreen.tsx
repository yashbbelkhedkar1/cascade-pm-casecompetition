  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50">
      ...
      <div className="p-6">
        ...
        {/* Title */}
        <h1 className="text-3xl font-bold text-gray-900 text-center mb-2">Complete Your KYC</h1>
        <p className="text-gray-600 text-center mb-8">Secure your account with bank verification</p>
