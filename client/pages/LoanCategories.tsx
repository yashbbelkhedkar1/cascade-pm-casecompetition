  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="p-4">
        ...
        <h2 className="text-lg font-semibold mb-6 text-gray-900">Browse Categories</h2>
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center flex-1">
                  <div className={`w-14 h-14 ${category.bgColor} rounded-xl flex items-center justify-center mr-4`}>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4">
                      <span className="text-sm">
                        <span className="text-purple-600 font-medium">From {category.rateFrom}</span>
                      </span>
                      <span className="text-xs text-gray-500">• {category.offers} offers</span>
                    </div>
                  </div>
                </div>
