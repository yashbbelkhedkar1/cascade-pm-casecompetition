  ...
  if (currentView === "landing") {
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50">
        ...
        {/* Title */}
        <h1 className="text-4xl font-bold text-gray-900 text-center mb-3">Split</h1>
        <p className="text-gray-600 text-center mb-12 px-4">Split expenses easily with friends and groups</p>
        ...
        <div className="w-full max-w-sm space-y-4 mb-8">
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <div className="flex items-center mb-3">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">Add friends and family</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <div className="flex items-center mb-3">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">Log shared costs and splits</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <div className="flex items-center mb-3">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">Settle Balances</h3>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="bg-blue-600 text-white p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <button onClick={() => setCurrentView("landing")} className="mr-3">
        ...
        <div className="p-4">
          ...
          <div className="bg-white rounded-2xl p-6 mb-6 border-2 border-dashed border-gray-200 text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Create a new group</h3>
            <button
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="flex-1">
                        ...
                        <span className="text-xs text-green-600">{group.status}</span>
                      </div>
                    </div>
                  </button>
                ))}
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="p-4">
          <div className="bg-white rounded-2xl p-6 mb-6">
            <h3 className="text-lg font-semibold mb-4">Add friends by email or phone number</h3>
          ...
          <div className="bg-white rounded-2xl p-6 mb-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-3">
                {["Trip", "Dinner", "Groceries", "Utilities", "Rent", "Vacation", "Party", "Movie Night"].map((suggestion) => (
                  <button
                    key={suggestion}
      ...
      <div className="p-4">
        <div className="bg-white rounded-2xl p-6 mb-6">
          ...
          <div className="flex items-center py-3">
            ...
            <span className="text-sm bg-green-100 text-green-800 px-3 py-1 rounded-full">Settled up</span>
          </div>
        </div>
